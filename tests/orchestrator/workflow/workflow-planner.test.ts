...
describe('planWorkflow', () => {
  ...
  test('LLM returns valid JSON → parsed as WorkflowPlan', async () => {
    const validPlan = JSON.stringify({
      ...
      steps: [
        { id: 'step1', description: 'read auth files', strategy: 'knowledge-query', dependencies: [], inputs: {}, expectedOutput: 'file contents', budgetFraction: 0.2 },
        { id: 'step2', description: 'fix the bug', strategy: 'full-pipeline', dependencies: ['step1'], inputs: { context: '$step1.result' }, expectedOutput: 'fixed code', budgetFraction: 0.6 },
        { id: 'step3', description: 'summarize changes', strategy: 'llm-reasoning', dependencies: ['step2'], inputs: { changes: '$step2.result' }, expectedOutput: 'summary', budgetFraction: 0.2 },
      ],
