...
export function renderPrometheus(
  ...
  parts.push(renderMetric(
    "vinyan_tasks_total",
    "Total tasks processed",
    "counter",
    metrics.traces.total,
  ));
  ...
  parts.push(renderMetric(
    "vinyan_rules_active",
    "Number of active evolutionary rules",
    "gauge",
    metrics.rules.active,
  ));

  // vinyan_rules_probation (gauge)
  parts.push(renderMetric(
    "vinyan_rules_probation",
    "Number of rules in probation",
    "gauge",
    metrics.rules.probation,
  ));

  // vinyan_skills_active (gauge)
  parts.push(renderMetric(
    "vinyan_skills_active",
    "Number of active cached skills",
    "gauge",
    metrics.skills.active,
  ));

  // vinyan_skills_probation (gauge)
  parts.push(renderMetric(
    "vinyan_skills_probation",
    "Number of skills in probation",
    "gauge",
    metrics.skills.probation,
  ));

  // vinyan_shadow_queue_depth (gauge)
  parts.push(renderMetric(
    "vinyan_shadow_queue_depth",
    "Shadow validation queue depth",
    "gauge",
    metrics.shadow.queueDepth,
  ));
  ...
  parts.push(renderLabeledMetric(
    "vinyan_guardrail_detections_total",
    "Total guardrail detections by type",
    "counter",
    {
  ...
  parts.push(renderLabeledMetric(
    ...
    "Whether a data gate is satisfied (0 or 1)",
    "gauge",
    {
