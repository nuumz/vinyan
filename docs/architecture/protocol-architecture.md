...
| **§6 Trust Degradation Matrix — canonical source** for the full cross-layer trust model | ECP v2 research directions → [ecp-research.md](../research/ecp-research.md) |
...
| D10 | Multi-oracle combination | Priority-based heuristic (v1); DS combination as v2 research | v1: 5-step deterministic resolution in `conflict-resolver.ts`. v2: Dempster's rule under investigation — see [ecp-research.md §2](../research/ecp-research.md#2-multi-oracle-aggregation-ds-combination). |
...
| D12 | Evidence integrity | Merkle-chained evidence in v2 | Certificate Transparency pattern for tamper-proof evidence chains. See [ecp-research.md §4](../research/ecp-research.md#4-merkle-chained-evidence). |
