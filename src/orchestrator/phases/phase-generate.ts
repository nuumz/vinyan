    ...
    if (roleProtocolHandled) {
      ...
      if (plan?.collaborationMode === 'room' && plan.roomContract && deps.roomDispatcher) {
        try {
          ...
          workerResult = {
            ...
            tokensInput: dispatchOutcome.tokensInput,
            tokensOutput: dispatchOutcome.tokensOutput,
      ...
      if (!roomHandled && lastAgentResult) {
        ...
        workerResult = {
          ...
          tokensInput: lastAgentResult.tokensInput,
          tokensOutput: lastAgentResult.tokensOutput,
