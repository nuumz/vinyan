...
export const CODING_TASKS: CodingTask[] = [
...

  {
    ...
    errorCategory: "import-dependency",
    errorDetail: "formatDate does not exist in ./utils.ts; it only exports formatCurrency, generateId, deepClone, groupBy",
  },
...

  {
    ...
    errorCategory: "structural",
    errorDetail: "TimeoutError extends OrderService which expects UserService in constructor, not (string, string, number)",
  },
...

  {
    ...
    errorCategory: "structural",
    errorDetail: "Property message does not exist on type { kind: \"ok\"; value: string }; discriminant narrowing violation",
  },

  {
    ...
    errorCategory: "structural",
    errorDetail: "createOrder(userId: string, ...) is incompatible with base class signature createOrder(userId: number, ...)",
  },
