...
import {
  ...
  computeQualityTrend,
} from "../../src/observability/phase3-report.ts";
...
import type { ExecutionTrace, EvolutionaryRule, CachedSkill } from "../../src/orchestrator/types.ts";
      ...
      for (let i = 0; i < 20; i++) {
        stores.traceStore.insert(makeTrace({
          predictionError: {
            ...
            predicted: {} as any,
            actual: {} as any,
            error: { testResultMatch: true, blastRadiusDelta: 0, durationDelta: 0, qualityScoreDelta: 0.1, composite: 0.1 },
          },
        }));
      }
