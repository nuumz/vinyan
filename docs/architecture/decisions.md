...
> **RFC note (2026-04):** Three additional invariants — **A8 Traceable Accountability**, **A9 Resilient Degradation**, **A10 Goal-and-Time Grounding** — are documented as *Proposed Core Extensions* in [concept.md §1.1.1](../foundation/concept.md). They are not yet binding; the official axiom set remains A1–A7. New decisions may reference A8–A10 as motivation, but their promotion gates are minimum runtime slices, not documentation alone.
